...
if [ "$TRAVIS_REPO_SLUG" == "locomotivemtl/charcoal-validator" ] && [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_PHP_VERSION" == "5.6" ]; then
    ...
    echo ">>> http://locomotivemtl.github.io/charcoal-validator/apigen/$TRAVIS_BRANCH/ \n"
fi
